...
const locale: LocaleProps = {
  ...
  settings: {
    ...
    iconPacks: {
      ...
      additionalPacks: "অতিরিক্ত আইকন প্যাক",
      additionalPacksDesc: "কোর Isoflow আইসোমেট্রিক এবং সবসময় উপলব্ধ; ঐচ্ছিক প্যাকগুলোর ভিজ্যুয়াল স্টাইল ভিন্ন হতে পারে।",
