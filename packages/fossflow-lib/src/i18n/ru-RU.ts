...
const locale: LocaleProps = {
  ...
  settings: {
    ...
    iconPacks: {
      ...
      additionalPacks: "Дополнительные пакеты иконок",
      additionalPacksDesc: "Core Isoflow изометрический и всегда доступен; дополнительные пакеты могут использовать другие визуальные стили.",
